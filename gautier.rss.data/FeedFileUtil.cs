namespace gautier.rss.data
{
    ...
    {
        public static string GetRSSXmlFeedFilePath(in string feedSaveDirectoryPath, in Feed feedInfo) => Path.Combine(feedSaveDirectoryPath, $"{feedInfo.FeedName}.xml");

        public static string GetRSSTabDelimitedFeedFilePath(in string feedSaveDirectoryPath, in Feed feedInfo) => Path.Combine(feedSaveDirectoryPath, $"{feedInfo.FeedName}.txt");
